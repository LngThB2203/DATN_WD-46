...
class CategoryController extends Controller
{
    ...
    public function trash(Request $request)
    {
        ...
        $categories = $query->orderByDesc('deleted_at')->paginate(10);
        $categories->appends(['search' => $request->search]);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.categories.list')->with('success', 'Danh mục đã được xóa tạm!');
    }
    ...
    public function forceDelete($id)
    {
        ...
        return redirect()->route('admin.categories.trash')->with('success', 'Xóa danh mục vĩnh viễn thành công!');
    }
