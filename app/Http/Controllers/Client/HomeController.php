...
class HomeController extends Controller
{
    public function index()
    {
        ...
        // Sản phẩm bán chạy nhất (theo số lượng reviews hoặc có thể thay bằng orders)
        $bestSellingProducts = Product::with(['galleries', 'variants', 'variants.size', 'variants.scent', 'variants.concentration'])
            ->where('status', 1)
            ->withCount('reviews')
        ...
        return view('client.home', compact('products', 'bestSellingProducts', 'categories', 'heroBanners'));
    }
