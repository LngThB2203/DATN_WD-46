                ...
                <div class="card card-height-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ps-3"><a href="index.html#" class="text-muted">larkon/ecommerce.html</a>
                                    </td>
                                    <td>465 </td>
                                    <td><span class="badge badge-soft-success">4.4%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="index.html#" class="text-muted">larkon/dashboard.html</a>
                                    </td>
                                    <td> 426</td>
                                    <td><span class="badge badge-soft-danger">20.4%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="index.html#" class="text-muted">larkon/chat.html</a></td>
                                    <td>254 </td>
                                    <td><span class="badge badge-soft-warning">12.25%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="index.html#" class="text-muted">larkon/auth-login.html</a>
                                    </td>
                                    <td> 3369</td>
                                    <td><span class="badge badge-soft-success">5.2%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="index.html#" class="text-muted">larkon/email.html</a></td>
                                    <td>985 </td>
                                    <td><span class="badge badge-soft-danger">64.2%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="index.html#" class="text-muted">larkon/social.html</a>
                                    </td>
                                    <td>653 </td>
                                    <td><span class="badge badge-soft-success">2.4%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="index.html#" class="text-muted">larkon/blog.html</a></td>
                                    <td>478 </td>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>29 April 2024</td>
                                    <td>
                                        <img src="{{asset('assets/admin/images/products/product-1(1).png')}}" alt="product-1(1)"
                                            class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                        <a href="index.html#!">Anna M. Hines</a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>25 April 2024</td>
                                    <td>
                                        <img src="{{asset('assets/admin/images/products/product-4.png')}}" alt="product-4"
                                            class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                        <a href="index.html#!">Judith H. Fritsche</a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>25 April 2024</td>
                                    <td>
                                        <img src="{{asset('assets/admin/images/products/product-5.png')}}" alt="product-5"
                                            class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                        <a href="index.html#!">Peter T. Smith</a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>21 April 2024</td>
                                    <td>
                                        <img src="{{asset('assets/admin/images/products/product-6.png')}}" alt="product-6"
                                            class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                        <a href="index.html#!">Emmanuel J. Delcid</a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>18 April 2024</td>
                                    <td>
                                        <img src="{{asset('assets/admin/images/products/product-1(2).png')}}" alt="product-1(2)"
                                            class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                        <a href="index.html#!">William J. Cook</a>
                                    </td>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-auto">
                                <ul class="pagination m-0">
                                    <li class="page-item">
                                        <a href="index.html#" class="page-link"><i class="bx bx-left-arrow-alt"></i></a>
                                    </li>
