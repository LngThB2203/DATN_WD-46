            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="d-flex card-header justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            <a href="invoice-list.html#" class="dropdown-toggle btn btn-sm btn-outline-light rounded"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                This Month
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a href="invoice-list.html#!" class="dropdown-item">Download</a>
                                <!-- item-->
                                <a href="invoice-list.html#!" class="dropdown-item">Export</a>
                                <!-- item-->
                                <a href="invoice-list.html#!" class="dropdown-item">Import</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="invoice-list.html#!" class="btn btn-light btn-sm">
                                                    <iconify-icon icon="solar:eye-broken" class="align-middle fs-18">
                                                    </iconify-icon>
                                                </a>
                                                <a href="invoice-list.html#!" class="btn btn-soft-primary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                                    <iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18">
                                                    </iconify-icon>
                                                </a>
                                                <a href="invoice-list.html#!" class="btn btn-soft-danger btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="assets/images/users/avatar-3.jpg"
                                                class="avatar-sm rounded-circle me-2" alt="..."> Theresa T. Brose</td>
                                        <td> 03 Dec, 2023</td>
                                        <td> $783 </td>
                                        <td> Visa </td>
                                        <td> <span class="badge bg-danger-subtle text-danger px-2 py-1">Cancel</span>
                                        </td>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="invoice-list.html#!" class="btn btn-light btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="assets/images/users/avatar-5.jpg"
                                                class="avatar-sm rounded-circle me-2" alt="..."> Lily W. Wilson</td>
                                        <td>10 Aug, 2023</td>
                                        <td> $945 </td>
                                        <td> Mastercard</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="assets/images/users/avatar-6.jpg"
                                                class="avatar-sm rounded-circle me-2" alt="..."> Sarah M. Brooks</td>
                                        <td> 22 May, 2023 </td>
                                        <td> $421</td>
                                        <td> Visa</td>
                                        <td> <span class="badge bg-danger-subtle text-danger px-2 py-1 ">Cancel</span>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="assets/images/users/avatar-7.jpg"
                                                class="avatar-sm rounded-circle me-2" alt="..."> Joe K. Hall</td>
                                        <td>15 Mar, 2023
                                        </td>
                                        <td>$251 </td>
                                        <td> Paypal </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="assets/images/users/avatar-8.jpg"
                                                class="avatar-sm rounded-circle me-2" alt="...">Ralph Hueber</td>
                                        <td>15 Mar, 2023
                                        </td>
                                        <td>$310 </td>
                                        <td> Visa </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="assets/images/users/avatar-9.jpg"
                                                class="avatar-sm rounded-circle me-2" alt="...">Sarah Drescher</td>
                                        <td>15 Mar, 2023
                                        </td>
                                        <td>$241 </td>
                                        <td> Mastercard </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="assets/images/users/avatar-10.jpg"
                                                class="avatar-sm rounded-circle me-2" alt="...">Leonie Meister</td>
                                        <td>15 Mar, 2023
                                        </td>
                                        <td>$136 </td>
                                        <td> Paypal </td>
