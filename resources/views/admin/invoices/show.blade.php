                    ...
                    <div class="card-body">
                        ...
                        <div class="clearfix pb-3 bg-info-subtle p-lg-3 p-2 m-n2 rounded position-relative">
                            <div class="float-sm-start">
                                <div class="auth-logo">
                                    <img class="logo-dark me-1" src="assets/images/logo-dark.png" alt="logo-dark"
                                        height="24" />
                                </div>
                                <div class="mt-4">
                                    <h4>Larkon Admin.</h4>
                                    ...
                                    <table class="table table-borderless mb-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end text-dark fw-semibold px-0 py-1">#INV-0758267/90
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="p-0 pe-5 py-1">
                            ...
                            <div class="float-sm-end">
                                <div class="">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <p class="mb-2"><span class="text-decoration-underline">Phone :</span> +(123)
                                            732-760-5760</p>
                                        <p class="mb-2"><span class="text-decoration-underline">Email :</span>
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <div>
                                                            <a href="invoice-details.html#!"
                                                                class="text-dark fw-medium fs-15">Men Black Slim Fit
                                                                T-shirt</a>
