                    ...
                    <div class="card-body">
                        ...
                        <div class="pb-3 mb-4 position-relative border-bottom">
                            <div class="row justify-content-between">
                                        ...
                                        <div class="w-50 auth-logo border border-primary bg-light-subtle p-2 rounded"
                                            ...
                                            <div class="profile-photo-edit">
                                                ...
                                                <label for="profile-img-file-input"
                                                    class="profile-photo-edit avatar-xs"><img
                                                        src="assets/images/logo-dark.png"
                                                        class="logo-dark me-1 user-profile-image"
                                                        alt="user-profile-image" height="24"></label>
                                            </div>
                                        </div>
                                        <div class="mt-5 pt-2">
                                            <form>
                                                <div class="mb-3">
                                                    <label for="sender-name" class="form-label text-dark">Sender
                                                        Name</label>
                                            ...
                                            <form>
                                                <div class="mb-3">
                                                    <label for="sender-address" class="form-label text-dark">Sender Full
                                                        Address</label>
                                                    <textarea class="form-control" id="sender-address" rows="3"
                                                        placeholder="Enter address"></textarea>
                                                </div>
                                            </form>
                                            <form>
                                                <div class="mb-3">
                                                    <label for="sender-number" class="form-label text-dark">Phone
                                                        number</label>
                                                    <input type="number" id="sender-number" class="form-control"
                                                        placeholder="Number">
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <div class="col-lg-5">
                                    <form>
                                        <div class="mb-3">
                                            <label for="invoice-no" class="form-label text-dark">Invoice Number
                                                :</label>
                                    ...
                                    <form>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="due-date" class="form-control flatpickr-input active"
                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-5">
                                ...
                                <form>
                                    <div class="mb-2">
                                        <input type="text" id="buyer-from" class="form-control"
                                            placeholder="First name">
                                    </div>
                                </form>
                                <form>
                                    <div class="mb-2">
                                        <textarea class="form-control" id="buyer-address" rows="3"
                                            placeholder="Enter address"></textarea>
                                    </div>
                                </form>
                                <form>
                                    <div class="mb-2">
                                        <input type="number" id="buyer-number" class="form-control"
                                            placeholder="Number">
                                    </div>
                                </form>
                                <form>
                            ...
                            <div class="col-lg-5">
                                ...
                                <form>
                                    <div class="mb-2">
                                        <textarea class="form-control" id="issuer-address" rows="3"
                                            placeholder="Enter address"></textarea>
                                    </div>
                                </form>
                                <form>
                                    <div class="mb-2">
                                        <input type="number" id="issuer-number" class="form-control"
                                            placeholder="Number">
                                    </div>
                                </form>
                                <form>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex gap-3">
                                                        <div class="auth-logo border-0 rounded"
                                                            style="border-style: dashed !important;">
                                                            <div class="profile-photo-edit">
                                                                <input id="profile-img-file-input1" type="file"
                                                                    class="profile-img-file-input1">
                                                                <label for="profile-img-file-input1"
                                                                    class="profile-photo-edit avatar bg-light rounded"><img
                                                                        src="invoice-add.html" alt=""
                                                                        class="me-1 user-profile-image1 img-fluid"
                                                                        alt="user-profile-image1"></label>
                                                            </div>
                                                        </div>
                                                        <div class="w-75">
                                                            <form>
                                                ...
                                                <td>
                                                    <form>
                                                        <div class="input-group">
                                                            <span class="input-group-text fs-20 bg-light text-dark"><i
                                                                    class="bx bx-dollar"></i></span>
                                                            <input type="number" id="product-price-table"
                                ...
                                <div class="text-end border-top">
                                    <div class="pt-3">
                                        <a href="invoice-add.html#!" class="btn btn-primary">Clear Product</a>
                                        <a href="invoice-add.html#!" class="btn btn-outline-primary">Add More</a>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                        </div>
