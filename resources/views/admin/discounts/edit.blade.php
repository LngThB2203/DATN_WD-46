                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" 
                                               value="{{ old('code', $discount->code) }}" placeholder="VD: SALE2024" required>
                                        @error('code')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="expiry_date" 
                                               ...
                                               value="{{ old('expiry_date', $discount->expiry_date?->format('Y-m-d')) }}">
                                        @error('expiry_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        @error('usage_limit')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="text-muted">Đã sử dụng: {{ $discount->used_count }}</small>
                                    </div>
                                </div>
