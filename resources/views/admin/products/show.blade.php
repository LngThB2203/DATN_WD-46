            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-1">
                            <a href="product-details.html#!" class="fs-24 text-dark fw-medium">Men Black Slim Fit
                                T-shirt</a>
                        </p>
                        ...
                        <p class="text-muted">Top in sweatshirt fabric made from a cotton blend with a soft brushed
                            ...
                            cuffs and hem. Small metal text applique. <a href="product-details.html#!"
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="d-flex align-items-center gap-3">
                                    <div
                                        ...
                                        <iconify-icon icon="solar:kick-scooter-bold-duotone" class="fs-35 text-primary">
                                        </iconify-icon>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="d-flex align-items-center gap-3">
                                    <div
                                        class="avatar bg-light d-flex align-items-center justify-content-center rounded">
                                        <iconify-icon icon="solar:ticket-bold-duotone" class="fs-35 text-primary">
                                        </iconify-icon>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="d-flex align-items-center gap-3">
                                    <div
                                        class="avatar bg-light d-flex align-items-center justify-content-center rounded">
                                        <iconify-icon icon="solar:gift-bold-duotone" class="fs-35 text-primary">
                                        </iconify-icon>
                                    </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <a href="product-details.html#!"
                                class="link-primary text-decoration-underline link-offset-2">View More Details <i
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            <a href="product-details.html#!" class="fs-14 me-3 text-muted"><i class='bx bx-like'></i>
                                Helpful</a>
