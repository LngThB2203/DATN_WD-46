                    ...
                    <div class="row">
                                        ...
                                        <div class="mt-3">
                                             <div class="row">
                                                  ...
                                                  <div class="col-lg-9">
                                                       ...
                                                       <div class="mt-2">
                                                            <a href="order-checkout.html#!" class="link-primary fw-medium">+ Add New Billing Address</a>
                                                       </div>
                         ...
                         <div class="col-lg-4">
                                   ...
                                   <div class="card-body">
                                        <div class="table-responsive">
                                             <div class="d-flex align-items-center gap-3 mb-4">
                                                  ...
                                                  <div>
                                                       <a href="order-checkout.html#!" class="text-dark fw-medium fs-15">Men Black Slim Fit T-shirt</a>
                                             ...
                                             <div class="d-flex align-items-center gap-3 mb-4">
                                                  ...
                                                  <div>
                                                       <a href="order-checkout.html#!" class="text-dark fw-medium fs-15">Dark Green Cargo Pent</a>
                                                       <p class="text-muted mb-0 mt-1 fs-13"><span>Size : </span>M</p>
                                                  </div>
                                                  <div class="ms-auto text-end">
                                             ...
                                             <div class="d-flex align-items-center gap-3 mb-4">
                                                  ...
                                                  <div>
                                                       <a href="order-checkout.html#!" class="text-dark fw-medium fs-15">Men Dark Brown Wallet</a>
                                             ...
                                             <div class="d-flex align-items-center gap-3 mb-4">
                                                  ...
                                                  <div>
                                                       <a href="order-checkout.html#!" class="text-dark fw-medium fs-15">Kid's Yellow T-shirt</a>
                                                       <p class="text-muted mb-0 mt-1 fs-13"><span>Size : </span>S</p>
                                                  </div>
                                                  <div class="ms-auto text-end">
                              ...
                              <div class="main-btn my-4 text-end">
                                   ...
                                   <a href="order-checkout.html#!" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#checkoutModal">Checkout Order</a>
                              </div>
                                        ...
                                        <div class="card border-0 mb-0">
                                             ...
                                             <div data-bs-theme="dark">
                                                  <div class="card-footer d-flex align-items-center border-0 bg-body gap-3 rounded">
                                                       ...
                                                       <div class="ms-auto">
                                                            <a href="order-checkout.html#!" class="text-primary fs-30" data-bs-toggle="tooltip" data-bs-title="Download Invoice" data-bs-placement="bottom"><iconify-icon icon="solar:download-square-bold" class="align-middle"></iconify-icon></a>
                                                       </div>
                                                  </div>
