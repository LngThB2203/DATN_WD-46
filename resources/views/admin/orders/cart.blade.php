        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="d-flex mb-4 bg-primary p-3 rounded">
                    ...
                    <a href="order-cart.html#!" class="ms-auto text-white fs-14 text-decoration-underline">Clear
                        cart</a>
                </div>
                <div class="card cart-detail">
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-sm">
                                <div class="ms-lg-3">
                                    <a href="order-cart.html#!" class="fw-medium text-dark fs-18">Men Black Slim Fit
                                        T-shirt</a>
                                    <div class="d-flex align-items-center gap-3 mt-2">
                                        <p class="text-dark fw-medium">Color : <span class="text-muted"> Dark </span>
                                        </p>
                            ...
                            <div class="col-sm-auto">
                                <div class="text-lg-end">
                                    ...
                                    <p class="mt-2 mb-0 fw-semibold fs-17">$80.00 <span class="fw-normal fs-14">/ $3.00
                                            Tex</span></p>
                                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-sm">
                                <div class="d-flex gap-3">
                                    <a href="order-cart.html#!" class="text-dark fs-14 d-flex align-items-center gap-1">
                                    ...
                                    <a href="order-cart.html#!"
                                        ...
                                        <iconify-icon icon="solar:heart-bold-duotone" class="fs-18"></iconify-icon>Add
                                        Wishlist
                                    </a>
                                </div>
                            </div>
                ...
                <div class="card cart-detail">
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-sm">
                                <div class="ms-lg-3">
                                    <a href="order-cart.html#!" class="fw-medium text-dark fs-18">Dark Green Cargo
                                        Pent</a>
                                    <div class="d-flex align-items-center gap-3 mt-2">
                                        <p class="text-dark fw-medium">Color : <span class="text-muted"> Dark
                                                Green</span></p>
                                        <p class="text-dark fw-medium">Size : <span class="text-muted"> M </span></p>
                            ...
                            <div class="col-sm-auto">
                                <div class="text-lg-end">
                                    <p class="fw-medium mb-0">Items Price</p>
                                    <p class="mt-2 mb-0 fw-semibold fs-17">$330.00 <span class="fw-normal fs-14">/ $4.00
                                            Tex</span></p>
                                </div>
                ...
                <div class="card cart-detail">
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-sm">
                                <div class="ms-lg-3">
                                    <a href="order-cart.html#!" class="fw-medium text-dark fs-18">Men Dark Brown
                                        Wallet</a>
                                    <div class="d-flex align-items-center gap-3 mt-2">
                                        <p class="text-dark fw-medium">Color : <span class="text-muted"> Brown</span>
                                        </p>
                            ...
                            <div class="col-sm-auto">
                                <div class="text-lg-end">
                                    <p class="fw-medium mb-0">Items Price</p>
                                    <p class="mt-2 mb-0 fw-semibold fs-17">$132.00 <span class="fw-normal fs-14">/ $5.00
                                            Tex</span></p>
                                </div>
                ...
                <div class="card cart-detail">
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-sm">
                                <div class="ms-lg-3">
                                    <a href="order-cart.html#!" class="fw-medium text-dark fs-18">Kid's Yellow
                                        T-shirt</a>
                                    <div class="d-flex align-items-center gap-3 mt-2">
                                        <p class="text-dark fw-medium">Color : <span class="text-muted"> Yellow </span>
                                        </p>
                                        <p class="text-dark fw-medium">Size : <span class="text-muted"> S </span></p>
                            ...
                            <div class="col-sm-auto">
                                <div class="text-lg-end">
                                    <p class="fw-medium mb-0">Items Price</p>
                                    <p class="mt-2 mb-0 fw-semibold fs-17">$220.00 <span class="fw-normal fs-14">/ $3.00
                                            Tex</span></p>
                                </div>
                            ...
                            <div class="form-button">
                                <form class="d-flex align-items-center justify-content-center">
                                    ...
                                    <button type="button" data-toast
                                        data-toast-text="Your Promo Code Apply Successfully" data-toast-gravity="top"
                                    ...
                                    <tr>
                                        <td class="px-0">
                                            <p class="d-flex mb-0 align-items-center gap-1">
                                                <iconify-icon icon="solar:clipboard-text-broken"></iconify-icon> Sub
                                                Total :
                                            </p>
                                        </td>
                                        ...
                                        <td class="px-0">
                                            <p class="d-flex mb-0 align-items-center gap-1">
                                                <iconify-icon icon="solar:calculator-minimalistic-broken"
                                                    class="align-middle"></iconify-icon> Estimated Tax (15.5%) :
                                            </p>
                                        </td>
                        ...
                        <div class="alert alert-warning alert-icon mt-3 mb-0" role="alert">
                            <div class="d-flex align-items-center">
                                <div
                                    ...
                                    <iconify-icon icon="solar:kick-scooter-broken" class="align-middle text-white">
                                    </iconify-icon>
                                </div>
