            ...
            <div class="col-xl-3 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-footer border-top">
                        <div class="row g-2">
                            <div class="col-lg-6">
                                <a href="category-edit.html#!" class="btn btn-outline-secondary w-100">Create
                                    Category</a>
                            </div>
                            <div class="col-lg-6">
                                <a href="category-edit.html#!" class="btn btn-primary w-100">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-9 col-lg-8 ">
                ...
                <div class="p-3 bg-light mb-3 rounded">
                    <div class="row justify-content-end g-2">
                        <div class="col-lg-2">
                            <a href="category-edit.html#!" class="btn btn-outline-secondary w-100">Save Change</a>
                        </div>
                        <div class="col-lg-2">
                            <a href="category-edit.html#!" class="btn btn-primary w-100">Cancel</a>
                        </div>
