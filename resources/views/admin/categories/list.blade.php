                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div
                                                    ...
                                                    <img src="{{asset('assets/admin/images/product/p-1.png')}}" alt=""
                                                        class="avatar-md">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div
                                                    class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="{{asset('assets/admin/images/product/p-2.png')}}" alt=""
                                                        class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div
                                                    class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="{{asset('assets/admin/images/product/p-4.png')}}" alt=""
                                                        class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div
                                                    class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="{{asset('assets/admin/images/product/p-6.png')}}" alt=""
                                                        class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div
                                                    class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="{{asset('assets/admin/images/product/p-7.png')}}" alt=""
                                                        class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div
                                                    class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="{{asset('assets/admin/images/product/p-8.png')}}" alt=""
                                                        class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div
                                                    class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="{{asset('assets/admin/images/product/p-11.png')}}" alt=""
                                                        class="avatar-md">
                                                </div>
                                                <div>
