            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarProducts">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('products.trash') }}">Sản Phẩm Xóa Tạm</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarCategory">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('admin.categories.trash') }}">Danh sách xóa tạm</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarInventory">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('inventories.stock-transactions.index') }}">Transactions</a>
                        </li>
                    </ul>
                </div>
            </li>
