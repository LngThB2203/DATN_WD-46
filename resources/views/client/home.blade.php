            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 image-col" data-aos="fade-left" data-aos-delay="200">
                    <div class="hero-image">
                        <img src="{{asset('assets/client/img/product/product-f-9.webp')}}" alt="Fashion Product"
                            class="main-product" loading="lazy">
                        <div class="floating-product product-1" data-aos="fade-up" data-aos-delay="300">
                            <img src="{{asset('assets/client/img/product/product-4.webp')}}" alt="Product 2">
                        ...
                        <div class="floating-product product-2" data-aos="fade-up" data-aos-delay="400">
                            <img src="{{asset('assets/client/img/product/product-3.webp')}}" alt="Product 3">
                            <div class="product-info">
                                <h4>Casual Wear</h4>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="category-card" data-aos="fade-up" data-aos-delay="100">
                            <div class="category-image">
                                <img src="{{asset('assets/client/img/product/product-1.webp')}}" alt="Category" class="img-fluid">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card" data-aos="fade-up" data-aos-delay="200">
                            <div class="category-image">
                                <img src="{{asset('assets/client/img/product/product-6.webp')}}" alt="Category" class="img-fluid">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card" data-aos="fade-up" data-aos-delay="300">
                            <div class="category-image">
                                <img src="{{asset('assets/client/img/product/product-9.webp')}}" alt="Category" class="img-fluid">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card" data-aos="fade-up" data-aos-delay="400">
                            <div class="category-image">
                                <img src="{{asset('assets/client/img/product/product-f-1.webp')}}" alt="Category" class="img-fluid">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card" data-aos="fade-up" data-aos-delay="500">
                            <div class="category-image">
                                <img src="{{asset('assets/client/img/product/product-10.webp')}}" alt="Category" class="img-fluid">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card" data-aos="fade-up" data-aos-delay="600">
                            <div class="category-image">
                                <img src="{{asset('assets/client/img/product/product-m-1.webp')}}" alt="Category" class="img-fluid">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="category-card" data-aos="fade-up" data-aos-delay="800">
                            <div class="category-image">
                                <img src="{{asset('assets/client/img/product/product-2.webp')}}" alt="Category" class="img-fluid">
                            </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-4">
                ...
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                    <div class="product-card">
                        <div class="product-image">
                            <img src="{{asset('assets/client/img/product/product-1.webp')}}" class="img-fluid default-image" alt="Product"
                                loading="lazy">
                            <img src="{{asset('assets/client/img/product/product-1-variant.webp')}}" class="img-fluid hover-image"
                ...
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="150">
                    <div class="product-card">
                        <div class="product-image">
                            <img src="{{asset('assets/client/img/product/product-4.webp')}}" class="img-fluid default-image" alt="Product"
                                loading="lazy">
                            <img src="{{asset('assets/client/img/product/product-4-variant.webp')}}" class="img-fluid hover-image"
                                alt="Product hover" loading="lazy">
                            <div class="product-tags">
                        ...
                        <div class="product-info">
                            <h3 class="product-title"><a href="product-details.html">Consectetur adipiscing elit</a>
                            </h3>
                            <div class="product-price">
                ...
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-card">
                        <div class="product-image">
                            <img src="{{asset('assets/client/img/product/product-7.webp')}}" class="img-fluid default-image" alt="Product"
                                loading="lazy">
                            <img src="{{asset('assets/client/img/product/product-7-variant.webp')}}" class="img-fluid hover-image"
                                alt="Product hover" loading="lazy">
                            <div class="product-actions">
                                <button class="btn-wishlist" type="button" aria-label="Add to wishlist">
                                    <i class="bi bi-heart"></i>
                ...
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="250">
                    <div class="product-card">
                        <div class="product-image">
                            <img src="{{asset('assets/client/img/product/product-12.webp')}}" class="img-fluid default-image" alt="Product"
                                loading="lazy">
                            <img src="{{asset('assets/client/img/product/product-12-variant.webp')}}" class="img-fluid hover-image"
                                alt="Product hover" loading="lazy">
                            <div class="product-tags">
